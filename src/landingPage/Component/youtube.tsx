const YoutubeDonationAboutSection = () => {
  return (
    <>
      <section className="bg-gradient-to-br from-[#0b0d10] to-[#101418] text-white" id="youtube-donate">
        <div className="container p-16 mx-auto max-w-6xl">
          {/* YouTube Section */}
      ...
      <section className="py-16 bg-gradient-to-br from-[rgba(124,92,255,0.15)] to-[rgba(0,209,255,0.1)] animate-[fadeUp_1s_ease] text-white" id="youtube-donate">
