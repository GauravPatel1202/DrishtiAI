  ...
  return (
      <section className="hero py-24 overflow-hidden">
          <div className="max-w-[1200px] mx-auto px-5 grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] gap-12 items-center">
              <div>
                  <span className="inline-block py-1.5 px-4 rounded-lg bg-[rgba(124,92,255,0.15)] text-[#00d1ff] text-sm font-semibold mb-4">🚀 Done New: Workflow Builder now in beta</span>
